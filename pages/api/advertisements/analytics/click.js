      ...
      try {
        ...
        if (!advertisement.analytics) {
          advertisement.analytics = {
            impressions: 1, // Au moins une impression pour avoir un clic
            clicks: 0,
            ctr: 0,
            viewDurations: [],
            devices: {},
        ...
        advertisement.analytics.clicks += 1;
        ...
        if (!advertisement.analytics.devices[deviceType]) {
          advertisement.analytics.devices[deviceType] = { impressions: 1, clicks: 0 };
        }
        advertisement.analytics.devices[deviceType].clicks += 1;
        
        // Tracking par position
        if (!advertisement.analytics.positions[position]) {
          advertisement.analytics.positions[position] = { impressions: 1, clicks: 0 };
        }
        advertisement.analytics.positions[position].clicks += 1;
        
        // Tracking par page
        if (!advertisement.analytics.pages[page]) {
          advertisement.analytics.pages[page] = { impressions: 1, clicks: 0 };
        }
        advertisement.analytics.pages[page].clicks += 1;
        ...
        if (pageContext) {
          ...
          if (!advertisement.analytics.contexts[pageContext]) {
            advertisement.analytics.contexts[pageContext] = { impressions: 1, clicks: 0 };
          }
          advertisement.analytics.contexts[pageContext].clicks += 1;
        }
        ...
        if (keywords && keywords.length > 0) {
          ...
          keywords.forEach(keyword => {
            if (!advertisement.analytics.keywords[keyword]) {
              advertisement.analytics.keywords[keyword] = { impressions: 1, clicks: 0 };
            }
            advertisement.analytics.keywords[keyword].clicks += 1;
          });
        }
        ...
        if (rotationGroup) {
          ...
          if (!advertisement.analytics.rotationGroups[rotationGroup]) {
            advertisement.analytics.rotationGroups[rotationGroup] = { impressions: 1, clicks: 0 };
          }
          advertisement.analytics.rotationGroups[rotationGroup].clicks += 1;
        }
