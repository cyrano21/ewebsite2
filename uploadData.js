...
const serviceAccount = require('./path/to/your-firebase-adminsdk.json');  // Assurez-vous que ce chemin est correct
...
async function uploadData() {
    const collectionRef = db.collection('products');  // Nom de votre collection dans Firestore
