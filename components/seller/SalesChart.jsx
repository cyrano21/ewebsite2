...
// Importer Chart.js de manière dynamique pour éviter les erreurs côté serveur
const Chart = dynamic(() => import('react-chartjs-2').then(mod => mod.Line), {
  ssr: false,
  loading: () => <p>Chargement du graphique...</p>
});

// Importer les modules nécessaires de Chart.js
// Ces imports sont nécessaires pour que le graphique fonctionne
import {
  Chart as ChartJS,
  CategoryScale,
  LinearScale,
