    ...
    >
      <Container fluid>
        ...
        <Navbar.Brand className="d-flex align-items-center">
          <Link to="/admin/dashboard" className={styles['navbar-brand-link']}>
        ...
        <Navbar.Collapse id="admin-navbar-nav">
          ...
          <Nav className="me-auto">
            <Nav.Link 
              as={Link} 
              to="/admin/dashboard" 
              className={`${styles['nav-link-animated']} ${isActive('/dashboard') ? styles.active : ''}`}
            >
            ...
            <Nav.Link 
              as={Link} 
              to="/admin/products" 
              className={`${styles['nav-link-animated']} ${isActive('/product') ? styles.active : ''}`}
            >
            ...
            <Nav.Link 
              as={Link} 
              to="/admin/orders" 
              className={`${styles['nav-link-animated']} ${isActive('/order') ? styles.active : ''}`}
            >
            ...
            <Nav.Link 
              as={Link} 
              to="/admin/customers" 
              className={`${styles['nav-link-animated']} ${isActive('/customer') ? styles.active : ''}`}
            >
          ...
          <div className={`d-flex align-items-center ${styles['navbar-actions']}`}>
            ...
            <Dropdown align="end">
              ...
              <Dropdown.Menu className={styles['dropdown-menu-animated']}>
                ...
                <Dropdown.Divider />
                <Dropdown.Item as={Link} to="/admin/help">
