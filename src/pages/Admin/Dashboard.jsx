          ...
          <Col>
            <Card className="shadow-sm">
              <Card.Header className="bg-white d-flex justify-content-between align-items-center">
                ...
                <Button variant="outline-primary" size="sm" as={Link} to="/admin/products">Voir tous les produits</Button>
              </Card.Header>
              <Card.Body>
                  ...
                  <tbody>
                    {popularProducts.map((product) => (
                      <tr key={product.id}>
                        ...
                        <td>
                          <Button variant="outline-primary" size="sm" className="me-2" as={Link} to={`/admin/products/edit/${product.id}`}>
                            <i className="icofont-ui-edit"></i>
                          </Button>
                          <Button variant="outline-info" size="sm" as={Link} to={`/shop-single/${product.id}`}>
          ...
          <Col md={6} className="mb-4">
            <Card className="border-warning h-100 shadow-sm">
              <Card.Body>
                ...
                <Button variant="outline-warning" size="sm" as={Link} to="/admin/orders">Voir les commandes</Button>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col md={6} className="mb-4">
            <Card className="border-danger h-100 shadow-sm">
              <Card.Body>
                ...
                <Button variant="outline-danger" size="sm" as={Link} to="/admin/products">Gérer le stock</Button>
              </Card.Body>
            </Card>
          </Col>
        </Row>
          ...
          <Col>
            <Card className="shadow-sm">
              <Card.Header className="bg-white d-flex justify-content-between align-items-center">
                ...
                <Button variant="outline-primary" size="sm" as={Link} to="/admin/orders">Voir toutes</Button>
              </Card.Header>
              <Card.Body>
                <Table responsive hover className="mb-0">
                  <thead>
                    ...
                    {cartOrders.map((order, index) => (
                      <tr key={`cart-${index}`} className="table-warning">
                        ...
                        <td>
                          ...
                          <Button variant="link" size="sm" className="p-0" as={Link} to="/admin/orders">
          ...
          <Col md={3} sm={6} className="mb-4">
            <Card className="text-center shadow-sm h-100">
              <Card.Body>
                ...
                <Button variant="primary" size="sm" as={Link} to="/admin/products">Accéder</Button>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col md={3} sm={6} className="mb-4">
            <Card className="text-center shadow-sm h-100">
              <Card.Body>
                ...
                <Button variant="success" size="sm" as={Link} to="/admin/customers">Accéder</Button>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col md={3} sm={6} className="mb-4">
            <Card className="text-center shadow-sm h-100">
              <Card.Body>
                ...
                <Button variant="info" size="sm" as={Link} to="/admin/reports">Accéder</Button>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Col md={3} sm={6} className="mb-4">
            <Card className="text-center shadow-sm h-100">
              <Card.Body>
                ...
                <Button variant="warning" size="sm" as={Link} to="/admin/settings">Accéder</Button>
              </Card.Body>
            </Card>
          </Col>
        </Row>
